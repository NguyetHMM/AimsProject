...
<head>
    ...
    <title>Aims Project</title>
    <meta name="description" content="">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    
    <!-- Place favicon.ico in the root directory -->
    <link rel="shortcut icon" type="image/x-icon" href="{{asset('Product/images/favicon.ico')}}">
    ...
    <link rel="stylesheet" href="{{asset('Product/css/core.css')}}">
    <!-- Theme shortcodes/elements style -->
    <link rel="stylesheet" href="{{asset('Product/css/shortcode/shortcodes.css')}}">
    <!-- Theme main style -->
    <link rel="stylesheet" href="{{asset('Product/css/style.css')}}">
    <!-- Responsive css -->
    <link rel="stylesheet" href="{{asset('Product/css/responsive.css')}}">
    <!-- User style -->
    <link rel="stylesheet" href="{{asset('Product/css/custom.css')}}">


    <!-- Modernizr JS -->
    <script src="{{asset('Product/js/vendor/modernizr-2.8.3.min.js')}}"></script>
</head>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-2 col-lg-2 col-sm-3 col-xs-3">
                            <div class="logo">
                                <a href="{{Route('index')}}">
                                    <img src="{{asset('Product/images/logo/logo.png')}}" alt="logo">
                                </a>
                            </div>
                        </div>
                        <!-- Start MAinmenu Ares -->
